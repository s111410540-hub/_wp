...
// .wrangler/tmp/bundle-odpgIo/checked-fetch.js
...
// .wrangler/tmp/pages-hNeQbR/bundledWorker-0.11686191362321119.mjs
...
var tt = /* @__PURE__ */ __name2((e11) => "Cloudflare-Workers".startsWith(e11), "tt");
...
async function Vi(e11) {
  await e11.prepare("CREATE TABLE IF NOT EXISTS players (id integer PRIMARY KEY AUTOINCREMENT NOT NULL, username text NOT NULL, password_hash text NOT NULL, hp integer DEFAULT 100 NOT NULL, max_hp integer DEFAULT 100 NOT NULL, mp integer DEFAULT 50 NOT NULL, max_mp integer DEFAULT 50 NOT NULL, location text DEFAULT 'roanoa' NOT NULL, gold integer DEFAULT 100 NOT NULL, level integer DEFAULT 1 NOT NULL, experience integer DEFAULT 0 NOT NULL)").run(), await e11.prepare("CREATE TABLE IF NOT EXISTS items (id integer PRIMARY KEY AUTOINCREMENT NOT NULL, name text NOT NULL, type text NOT NULL, description text NOT NULL, price integer NOT NULL, power integer DEFAULT 0 NOT NULL)").run(), await e11.prepare("CREATE TABLE IF NOT EXISTS inventory (id integer PRIMARY KEY AUTOINCREMENT NOT NULL, player_id integer NOT NULL, item_id integer NOT NULL, quantity integer DEFAULT 1 NOT NULL)").run();
}
__name(Vi, "Vi");
__name2(Vi, "Vi");
...
// .wrangler/tmp/bundle-odpgIo/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-odpgIo/middleware-loader.entry.ts
...
//# sourceMappingURL=bundledWorker-0.11686191362321119.js.map
