...
// .wrangler/tmp/bundle-dBGMN1/checked-fetch.js
...
// .wrangler/tmp/pages-PHxRRQ/bundledWorker-0.1547391601506929.mjs
...
var Oe = class e2 {
  ...
  insert(t3, n2, r2, i2, a2) {
    ...
    if (c2) {
      ...
      if (t4 && c2[2] && (n3 === ".*" || (n3 = n3.replace(/^\((?!\?:)(?=[^)]+\)$)/, "(?:"), /\((?!\?:)/.test(n3)))) throw y;
      if (l2 = this.#n[n3], !l2) {
        if (Object.keys(this.#n).some((e11) => e11 !== we && e11 !== Te)) throw y;
        if (a2) return;
        l2 = this.#n[n3] = new e2(), t4 !== "" && (l2.#t = i2.varIndex++);
      }
      !a2 && t4 !== "" && r2.push([t4, l2.#t]);
    } else if (l2 = this.#n[o2], !l2) {
      if (Object.keys(this.#n).some((e11) => e11.length > 1 && e11 !== we && e11 !== Te)) throw y;
      if (a2) return;
      l2 = this.#n[o2] = new e2();
    }
...
var $e = /* @__PURE__ */ ((e11) => (e11.HS256 = "HS256", e11.HS384 = "HS384", e11.HS512 = "HS512", e11.RS256 = "RS256", e11.RS384 = "RS384", e11.RS512 = "RS512", e11.PS256 = "PS256", e11.PS384 = "PS384", e11.PS512 = "PS512", e11.ES256 = "ES256", e11.ES384 = "ES384", e11.ES512 = "ES512", e11.EdDSA = "EdDSA", e11))($e || {});
var et = {
  deno: "Deno",
  bun: "Bun",
...
var S = /* @__PURE__ */ ((e11) => (e11.Encrypt = "encrypt", e11.Decrypt = "decrypt", e11.Sign = "sign", e11.Verify = "verify", e11.DeriveKey = "deriveKey", e11.DeriveBits = "deriveBits", e11.WrapKey = "wrapKey", e11.UnwrapKey = "unwrapKey", e11))(S || {});
...
async function Ct(e11, t3) {
  ...
  typeof e11 == "string" && e11.includes("PRIVATE") && (e11 = await wt(await crypto.subtle.importKey("pkcs8", xt(e11), t3, true, [S.Sign])));
  let n2 = [S.Verify];
...
function At(e11) {
  if (typeof e11 == "object" && e11) {
    let t3 = e11;
    return "alg" in t3 && Object.values($e).includes(t3.alg) && (!("typ" in t3) || t3.typ === "JWT");
  }
  return false;
}
__name(At, "At");
...
var Mt = /* @__PURE__ */ __name2(async (e11, t3, n2) => {
  ...
  if (!r2) throw new it();
  let l2 = e11.split(".");
  if (l2.length !== 3) throw new x(e11);
  let { header: u2, payload: d2 } = Ft(e11);
  if (!At(u2)) throw new ut(u2);
  if (u2.alg !== r2) throw new at(r2, u2.alg);
  let f2 = Math.floor(Date.now() / 1e3);
  if (a2 && d2.nbf && d2.nbf > f2) throw new ot(e11);
  if (o2 && d2.exp && d2.exp <= f2) throw new st(e11);
  if (s2 && d2.iat && f2 < d2.iat) throw new ct(f2, d2.iat);
  if (i2) {
    if (!d2.iss) throw new lt(i2, null);
    if (typeof i2 == "string" && d2.iss !== i2 || i2 instanceof RegExp && !i2.test(d2.iss)) throw new lt(i2, d2.iss);
  }
  if (c2) {
    if (!d2.aud) throw new ht(d2);
    if (!(Array.isArray(d2.aud) ? d2.aud : [d2.aud]).some((e12) => c2 instanceof RegExp ? c2.test(e12) : typeof c2 == "string" ? e12 === c2 : Array.isArray(c2) && c2.includes(e12))) throw new gt(c2, d2.aud);
  }
  let p2 = e11.substring(0, e11.lastIndexOf("."));
  if (!await bt(t3, r2, Ye(l2[2]), _t.encode(p2))) throw new mt(e11);
  return d2;
}, "Mt");
var Nt = [
  $e.HS256,
...
var Pt = /* @__PURE__ */ __name2(async (e11, t3, n2) => {
  ...
  if (Nt.includes(i2.alg)) throw new ft(i2.alg);
  if (!t3.allowedAlgorithms.includes(i2.alg)) throw new pt(i2.alg, t3.allowedAlgorithms);
  ...
  if (!o2) throw new x(e11);
  if (o2.alg && o2.alg !== i2.alg) throw new at(o2.alg, i2.alg);
...
var Z = Xr("players_v2", {
  ...
  magicSkill: K("magic_skill").notNull().default(0),
  swordSkill: K("sword_skill").notNull().default(0),
...
// .wrangler/tmp/bundle-dBGMN1/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-dBGMN1/middleware-loader.entry.ts
...
//# sourceMappingURL=bundledWorker-0.1547391601506929.js.map
